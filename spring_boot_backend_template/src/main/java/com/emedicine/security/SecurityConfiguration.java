package com.emedicine.security;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    	http.cors() // ✅ Explicitly Enable CORS
        .and().csrf()
                .disable()
...
//                .permitAll()
//                
//                .requestMatchers("/medicines/**")
//                .permitAll()
//                .requestMatchers("/admin/**")
//                .permitAll()
//.requestMatchers("/emedicine/customers/**").permitAll()
//.requestMatchers("/emedicine/customer-addresses/**").permitAll()
//.requestMatchers("/emedicine/orders/**").permitAll()
//
//.requestMatchers("/emedicine/cart/**").permitAll().requestMatchers("/api/prescription/**").permitAll()
//
//             
