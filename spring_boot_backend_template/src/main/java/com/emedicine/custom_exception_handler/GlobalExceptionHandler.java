package com.emedicine.custom_exception_handler;
...
import com.emedicine.custom_exceptions.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
	...
	public com.emedicine.dto.ApiResponse handleResourceNotFoundException
	(ResourceNotFoundException e) {
		System.out.println("in res not found " + e);
		return new com.emedicine.dto.ApiResponse(e.getMessage());
	}

	@ExceptionHandler(AuthenticationException.class)
	@ResponseStatus(value = HttpStatus.UNAUTHORIZED)
	public com.emedicine.dto.ApiResponse handleAuthenticationException(AuthenticationException e) {
	...
	public com.emedicine.dto.ApiResponse handleAccessDeniedException(AccessDeniedException e) {
	...
	public com.emedicine.dto.ApiResponse handleAnyException(RuntimeException e) {
