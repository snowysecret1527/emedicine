...
import '../comp_css/ForgotPassword.css';
...
const ForgotPassword = () => {
    ...
    const handleSendOtp = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8081/user/forgot-password', { // Your send OTP endpoint
                method: 'POST',
                headers: {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8081/user/verify-otp', { // Your verify OTP endpoint
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8081/user/reset-password', { // Your reset password endpoint
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
